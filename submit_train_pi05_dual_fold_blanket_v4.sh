#!/bin/bash
#SBATCH --job-name=train_pi05_dual_fold_blanket_v4
...
#SBATCH --mem=512G
#SBATCH --output=/home/n84416302/lerobot/slurm/train_pi05_dual_fold_blanket_v4_%j.out
#SBATCH --error=/home/n84416302/lerobot/slurm/train_pi05_dual_fold_blanket_v4_%j.err
