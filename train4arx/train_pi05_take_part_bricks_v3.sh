...
accelerate launch \
  ...
  --dynamo_backend=no \
  "$(which lerobot-train)" \
  --dataset.repo_id=yaoxianze/take_part_bricks_v3 \
  ...
  --output_dir=/home/n84416302/lerobot/results/arx_pi05_take_part_bricks_v3_4gpu_b16_c70n70_stateonly_s30k \
  --job_name=pi05_take_part_bricks_v3_4gpu_b16_c70n70_stateonly_s30k \
  --policy.repo_id=yaoxianze/arx_pi05_take_part_bricks_v3_4gpu_b16_c70n70_stateonly_s30k \
  ...
  --save_freq=15000 \
  --wandb.enable=true \
  --wandb.project=arx_pi05_take_part_bricks_v3 \
  --wandb.entity=yao-xian-ze \
  --wandb.notes="dataset=yaoxianze/take_part_bricks_v3; root=/home/n84416302/dataset/take_part_bricks_v3; machine=local_4gpu; policy=pi05; inputs=state+camera_h/l/r; chunk=70; n_action=70; expert_only=0; batch_per_gpu=16; steps=30000; save_freq=15000" \
